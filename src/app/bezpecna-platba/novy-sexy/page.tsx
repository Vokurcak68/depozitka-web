...
export default function BezpecnaPlatbaNovyPage() {
  ...
  if (success) {
    return (
      <Section bg="white">
        <SectionHeader
          eyebrow="Bezpečná platba · NOVÝ VZHLED"
  ...
  return (
    <Section bg="white">
      <SectionHeader
        ...
        title="Vytvořit nabídku rychle a na pohodu"
        subtitle="Stejná funkčnost jako klasický formulář, jen modernější vizuál a přehlednější průchod."
      />
